...
> **Audit methodology:** CAAS (Continuous Automated Assurance System) — a multi-layer automated audit framework: LLVM ct-verif, Valgrind taint analysis, dudect statistical timing, 470-module unified runner with 276 exploit PoC tests.
...
| [Audit Coverage](docs/AUDIT_COVERAGE.md) | Full audit report with 194 non-exploit modules + 276 exploit PoCs and platform verdicts |
