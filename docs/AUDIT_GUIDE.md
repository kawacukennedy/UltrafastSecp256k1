...
### What It Tests ( 197 non-exploit modules + 276 exploit PoC tests + standalone audit surfaces)
...
### OpenCL Audit Runner ( 473 modules, 8 sections)
...
### Metal Audit Runner ( 473 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 473 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 473 modules) |
