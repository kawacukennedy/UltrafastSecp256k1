...
| **Audit runner** | `unified_audit_runner` (193 non-exploit + 276 exploit PoCs = 469 modules) | `gpu_audit_runner` ( 469 modules) | `opencl_audit_runner` ( 469 modules) | `metal_audit_runner` ( 469 modules) |
