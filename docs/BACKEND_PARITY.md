...
| **Audit runner** | `unified_audit_runner` (198 non-exploit + 276 exploit PoCs = 474 modules) | `gpu_audit_runner` ( 474 modules) | `opencl_audit_runner` ( 474 modules) | `metal_audit_runner` ( 474 modules) |
