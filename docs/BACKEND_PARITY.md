...
| **Audit runner** | `unified_audit_runner` (197 non-exploit + 276 exploit PoCs = 473 modules) | `gpu_audit_runner` ( 473 modules) | `opencl_audit_runner` ( 473 modules) | `metal_audit_runner` ( 473 modules) |
