...
**Last updated**: 2026-04-21 | **Version**: 4.5.0
...
| **Audit runner** | `unified_audit_runner` (192 non-exploit + 276 exploit PoCs = 468 modules) | `gpu_audit_runner` ( 469 modules) | `opencl_audit_runner` ( 469 modules) | `metal_audit_runner` ( 469 modules) |
