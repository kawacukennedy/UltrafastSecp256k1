...
| **Audit runner** | `unified_audit_runner` (196 non-exploit + 276 exploit PoCs = 472 modules) | `gpu_audit_runner` ( 472 modules) | `opencl_audit_runner` ( 472 modules) | `metal_audit_runner` ( 472 modules) |
