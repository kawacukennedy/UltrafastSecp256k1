...
| **Audit runner** | `unified_audit_runner` (192 non-exploit + 276 exploit PoCs = 468 modules) | `gpu_audit_runner` ( 468 modules) | `opencl_audit_runner` ( 468 modules) | `metal_audit_runner` ( 468 modules) |
