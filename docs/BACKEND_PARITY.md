...
| **Audit runner** | `unified_audit_runner` (194 non-exploit + 276 exploit PoCs = 470 modules) | `gpu_audit_runner` ( 470 modules) | `opencl_audit_runner` ( 470 modules) | `metal_audit_runner` ( 470 modules) |
