...
from `docs/bench_unified_2026-09-07_gcc14_x86-64.json`
...
|----------|:---:|:---:|---|
| **GCC 14.2.0** (Linux default) | **1.52× faster** (+52%) | **1.48× faster** (+48%) | `docs/bench_unified_2026-09-07_gcc14_x86-64.json` |
