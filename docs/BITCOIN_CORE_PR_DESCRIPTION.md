...
and `docs/bench_unified_2026-09-07_gcc14_x86-64.json`.
...
All numbers from `docs/bench_unified_2026-09-07_gcc14_x86-64.json`
...
|---|---|---|---|
| **GCC 14.2.0 + LTO** | **+52% vs libsecp (1.52×)** | **+48% vs libsecp (1.48×)** | CT-vs-CT, canonical controlled run |
...
Full raw data: `docs/bench_unified_2026-09-07_gcc14_x86-64.json`.
...
Canonical data: `docs/bench_unified_2026-09-07_gcc14_x86-64.json`. ConnectBlock
