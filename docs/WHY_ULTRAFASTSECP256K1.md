...
| Exploit tests | 264 PoC files, 276 registered modules, 0 failures |
...
| Exploit PoC tests | 276 dedicated adversarial PoC modules across 20+ coverage categories (`audit/test_exploit_*.cpp`) | 276 wired, 0 failures |
...
| **Total (audit runner)** | **unified_audit_runner** across 194 non-exploit modules + 276 exploit-PoC modules (470 total) | **~1,000,000+** |
...
All 194 non-exploit audit modules across all tested platforms return **AUDIT-READY**. Zero failures in the current CI run (not a lifetime claim — see `docs/AUDIT_COVERAGE.md` for current status).
...
**Canonical x86-64 numbers (i5-14400F, GCC 14.2.0, 2026-09-07):**

Source: [`docs/bench_unified_2026-09-07_gcc14_x86-64.json`](bench_unified_2026-09-07_gcc14_x86-64.json)
